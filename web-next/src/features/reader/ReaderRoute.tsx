...
export function ReaderRoute() {
  ...
  useEffect(() => {
    ...
    const onWheel = (e: WheelEvent) => {
      // Paginated is click/swipe only — never advance from mouse wheel or trackpad.
      e.preventDefault()
    }
  ...
  const handlePagedSurfaceClick = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
    if (layoutRef.current !== 'paginated') return
    if (sheet !== 'none' || panel) return
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          overscrollBehavior: paginated ? 'none' : undefined,
        }}
        onClick={paginated ? handlePagedSurfaceClick : undefined}
      >
      <div
        ref={pageStageRef}

...
import { PwaLayout } from '@/app/PwaLayout'
import { RouteError } from '@/app/RouteError'

const hydrateFallbackElement = (
  <div className="text-muted-foreground flex min-h-[240px] items-center justify-center px-4 text-sm">
    Loading...
  </div>
)
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            lazy: () =>
              lazyRoute(() =>
                import('@/features/notes/NotesRoute').then((mod) => ({
                  Component: mod.NotesRoute,
                })),
              ),
            errorElement: <RouteError />,
            hydrateFallbackElement,
          ...
          },
          {
            ...
            lazy: () =>
              lazyRoute(() =>
                import('@/features/studio/StudioRoute').then((mod) => ({
                  Component: mod.StudioRoute,
                })),
              ),
            errorElement: <RouteError />,
            hydrateFallbackElement,
